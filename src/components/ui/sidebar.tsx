        ...
        <div className="flex h-screen w-full items-center justify-center bg-background">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Ha ocurrido un error al cargar el sidebar. Por favor, recarga la
              página.
            </p>
          </div>
        </div>
...
// Función para leer cookies de manera segura
...
function useSidebar() {
  ...
  if (!context) {
    console.warn(
      "useSidebar must be used within a SidebarProvider. Returning default values."
    );
...
>(
  (
    ...
    // Inicializar estado desde cookie de manera segura
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Guardar estado en cookie de manera segura
        setCookie(
          SIDEBAR_COOKIE_NAME,
          openState.toString(),
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-[--sidebar-width] bg-transparent transition-all duration-200",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-screen w-[--sidebar-width] transition-all duration-200 md:flex",
            ...
            state === "collapsed" &&
              collapsible === "icon" &&
              (variant === "floating" || variant === "inset"
                ? "w-[calc(var(--sidebar-width-icon)_+_1rem)] p-2"
                : "w-[--sidebar-width-icon]"),
        ...
        >
          <div
            ...
            className={cn(
              ...
              variant === "floating" &&
                "rounded-lg border border-sidebar-border shadow-md"
            )}
          >
            {children}
          </div>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all duration-200",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "outline-none ring-sidebar-ring transition-all duration-200 focus-visible:ring-2",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "text-sidebar-foreground outline-none ring-sidebar-ring transition-all duration-200",
